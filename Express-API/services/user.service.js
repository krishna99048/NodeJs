...
// When create a service -- when you want to database
...
module.exports.forgetPassword = async (email) => {
    ...
    // token will be validate only 15 minutes after 15 minutes token  will be expiry and you cant't reset your password

    await user.save();

    const resetLink = `http://localhost:3002/reset-password/${token}`
    // resetLink = frontend page link that show new password filed with change password btn
